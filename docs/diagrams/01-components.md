...
flowchart TB
    ...
    subgraph ENC [enclave crate — utexo-bridge-enclave]
        ...
        BCfg[config.rs — BridgeConfig env pins<br/>EVM_CHAIN_ID / EVM_PROXY_CONTRACT_ADDRESS / RGB_ASSET_ID<br/>GAS_TX_ALLOWED_TO / GAS_TX_MAX_VALUE_WEI<br/>FUNDS_IN_CONTRACT / BTC_MAX_TOTAL_SATS]
