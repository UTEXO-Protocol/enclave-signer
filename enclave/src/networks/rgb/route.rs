...
use super::flow;
#[cfg(any(not(feature = "dev-mode"), feature = "rgb-validation"))]
...
///
/// Field-level checks, consignment validation, asset binding, and SPV
/// verification live in `validation.rs` when `rgb-validation` is enabled.
